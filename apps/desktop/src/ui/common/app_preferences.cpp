...
const QHash<QString, QString> &translations()
{
    static const QHash<QString, QString> values = {
        ...
        {QStringLiteral("自动化"), QStringLiteral("Automation")},
        ...
        {QStringLiteral("刷新自动化产物"), QStringLiteral("Refresh automation artifacts")},
        {QStringLiteral("打开/运行"), QStringLiteral("Open / Run")},
        {QStringLiteral("在默认浏览器中打开选中的 HTML 文件"),
         QStringLiteral("Open the selected HTML file in the default browser")},
        {QStringLiteral("HTML 产物"), QStringLiteral("HTML artifacts")},
        {QStringLiteral("搜索脚本或报告"), QStringLiteral("Search scripts or reports")},
        {QStringLiteral("脚本"), QStringLiteral("Script")},
        {QStringLiteral("报告"), QStringLiteral("Report")},
        {QStringLiteral("相对路径"), QStringLiteral("Relative path")},
        {QStringLiteral("暂无 HTML 产物"), QStringLiteral("No HTML artifacts")},
        {QStringLiteral("无法调用默认浏览器打开文件"),
         QStringLiteral("Unable to open the file in the default browser")},
        {QStringLiteral("已在默认浏览器中打开：%1"),
         QStringLiteral("Opened in the default browser: %1")},
        {QStringLiteral("共 %1 个 HTML 产物"), QStringLiteral("%1 HTML artifacts")},
